 ...
 *
 * It has no props of its own on purpose: its size is its only variable, and a consumer already has
 * two ways to set a size — `style` and `className` — so a `width`/`height` pair would be a second,
 * narrower spelling of what CSS does better inside a grid or a flex row.
 *
 ...
 * nobody can reach. It belongs behind a real load rather than behind a timer: a placeholder that
 * appears on a schedule is a placeholder that lies.
 */
